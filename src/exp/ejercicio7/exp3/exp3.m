...
[n_x_aristas_ej4, y_aristas_ej4, e_aristas_ej4, cant_aristas_ej4] = leer_datos_float('aristas-ej4-exp3-f3.txt');
[n_x_aristas_ej5, y_aristas_ej5, e_aristas_ej5, cant_aristas_ej5] = leer_datos_float('aristas-ej5-exp3-f3-tipo1.txt');
[n_x_aristas_ej6, y_aristas_ej6, e_aristas_ej6, cant_aristas_ej6] = leer_datos_float('aristas-ej6-exp3-f3-tipo1.txt');
