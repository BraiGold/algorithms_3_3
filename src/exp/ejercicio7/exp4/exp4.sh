...
for i in $n1; do
  ...
  printf "%d\n " $i
  aux=$((i/4))
  nodosCompleto=$((aux+i/2))
  printf "combinacion1 %d %d %d %d \n" 5 6 $i $nodosCompleto | $(dirname $0)/../../../generador-grafosEspeciales
done
...
printf "%d \n" 1 >> $(dirname $0)/aristas-combinacion1-ej6-exp4-tipo1.txt
  ...
  for k in $n1; do
    ...
    aux1=$((k/4))
    nodosCompleto=$((aux1+k/2))
    aux=$((nodosCompleto-1))
    aux2=$((nodosCompleto*aux))
    m2=$((aux2/2))
    echo "Esta corriendo la instancia numero"
    printf "%d\n " $k
    $(dirname $0)/../../../ejercicio3 < $(dirname $0)/combinacion1/grafo-n1-$k-n2-$nodosCompleto-m2-$m2.txt | $(dirname $0)/../../../dameCantAristas >> $(dirname $0)/aristas-combinacion1-ej3-exp4.txt
  ...
  for k in $n1; do
    ...
    echo "Esta corriendo la instancia numero"
    printf "%d\n " $k
    $(dirname $0)/../../../ejercicio4 < $(dirname $0)/combinacion1/grafo-n1-$k-n2-$nodosCompleto-m2-$m2.txt | $(dirname $0)/../../../dameCantAristas >> $(dirname $0)/aristas-combinacion1-ej4-exp4.txt
  ...
  for k in $n1; do
    ...
    echo "Esta corriendo la instancia numero"
    printf "%d\n " $k
    $(dirname $0)/../../../ejercicio5-tipo1 < $(dirname $0)/combinacion1/grafo-n1-$k-n2-$nodosCompleto-m2-$m2.txt $cuantosMiro | $(dirname $0)/../../../dameCantAristas >> $(dirname $0)/aristas-combinacion1-ej5-exp4-tipo1.txt
    printf "\n" >> $(dirname $0)/aristas-combinacion1-ej5-exp4-tipo1.txt
  done

  for k in $n1; do
    printf "%d " $k >> $(dirname $0)/aristas-combinacion1-ej6-exp4-tipo1.txt
    aux1=$((k/4))
    nodosCompleto=$((aux1+k/2))
    aux=$((nodosCompleto-1))
    aux2=$((nodosCompleto*aux))
    ...
    echo "Esta corriendo la instancia numero"
    printf "%d\n " $k
    $(dirname $0)/../../../ejercicio6-tipo1 < $(dirname $0)/combinacion1/grafo-n1-$k-n2-$nodosCompleto-m2-$m2.txt $cuantosMiro $tamTabu $z | $(dirname $0)/../../../dameCantAristas >> $(dirname $0)/aristas-combinacion1-ej6-exp4-tipo1.txt
